...
const Glosariolista = () => {
  return (
    <>
      <div
        className="grid grid-rows-[repeat(21,1fr)] grid-cols-[repeat(28,1fr)] rounded-[3px] bg-gray-keto shadow-lg shadow-black col-start-1 col-end-[29] row-start-1 row-end-[22] text-white gap-2 z-0
          sm:bg-gray-keto sm:col-start-1 sm:col-end-[29] sm:row-start-1 sm:row-end-[22]
