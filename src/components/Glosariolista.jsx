...
const Glosariolista = () => {
  return (
    <>
      <div
        className="grid grid-rows-[repeat(21,1fr)] grid-cols-[repeat(28,1fr)] rounded-[3px] bg-gray-keto shadow-lg shadow-black col-start-1 col-end-[29] row-start-1 row-end-[22] text-white z-0
